...
from src.agents.thread_state import ThreadDataState, ThreadRuntimeContext, ThreadState
...
def get_thread_data(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState] | None) -> ThreadDataState | None:
...
def is_local_sandbox(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState] | None) -> bool:
...
def sandbox_from_runtime(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState] | None = None) -> Sandbox:
...
def ensure_sandbox_initialized(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState] | None = None) -> Sandbox:
...
def ensure_thread_directories_exist(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState] | None) -> None:
...
def bash_tool(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState], description: str, command: str) -> str:
...
def ls_tool(runtime: ToolRuntime[ThreadRuntimeContext, ThreadState], description: str, path: str) -> str:
