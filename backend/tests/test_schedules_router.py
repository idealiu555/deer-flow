...
async def test_gateway_lifespan_stops_scheduler_before_channel(monkeypatch) -> None:
    ...
    monkeypatch.setattr("app.channels.service.start_channel_service", _start_channel_service)
    monkeypatch.setattr("deerflow.scheduler.service.start_scheduler_service", _start_scheduler_service)
    monkeypatch.setattr("deerflow.scheduler.service.stop_scheduler_service", _stop_scheduler_service)
    monkeypatch.setattr("app.channels.service.stop_channel_service", _stop_channel_service)
