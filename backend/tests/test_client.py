...
class TestScheduleApis:
    def test_wake_scheduler_starts_service_before_wake(self):
        ...
        with (
            patch("src.client.start_scheduler_service", new=start_service),
            patch("src.client.wake_running_scheduler_service_best_effort", return_value=False) as wake_running,
            patch("src.client._get_scheduler_wake_loop", return_value=fake_loop),
    ...
    def test_wake_scheduler_uses_running_service_without_cross_loop_start(self):
        with (
            patch("src.client.wake_running_scheduler_service_best_effort", return_value=True) as wake_running,
            patch("src.client._get_scheduler_wake_loop") as get_wake_loop,
            patch("src.client.start_scheduler_service", new=AsyncMock()) as start_service,
